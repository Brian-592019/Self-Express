<?php
	...
	$login = new Login();
	$_SESSION['selfexpress_userid'] = isset($_SESSION['selfexpress_userid']) ? $_SESSION['selfexpress_userid'] : 0;
	
	$user_data = $login->check_login($_SESSION['selfexpress_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['selfexpress_userid']);

		}else{

			$post = new Post();
			$id = $_SESSION['selfexpress_userid'];
...
<!DOCTYPE html>
	...
	<link rel="stylesheet" href="../styles/website.css" />
		<title>Profile | Self-Express</title>
	</head>
	<body style:="color: white">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: whitesmoke;text-align: center;color: #1C2125">
				...
				<span style="font-size: 12px;">
					...
					<?php if(i_own_content($user_data)):?>
						...
						<a onclick="show_change_cover_image(event)" style="text-decoration: none;color:black;" href="change_profile_image.php?change=cover">Change Cover</a>
				...
				<br>
					...
					<div style="font-size: 20px;color: black;">
						...
						<a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
							<input id="post_button" type="button" value="Follow <?php echo $mylikes ?>" style="margin-right:10px;background-color: #FCEFEF;width:auto;">
						</a>
				...
				<?php 
					if($user_data['userid'] == $_SESSION['selfexpress_userid']){
